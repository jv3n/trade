...
/**
 * Raised when the market data provider cannot serve the request : rate-limited, temporary upstream
 * error, or unreachable. Mapped to HTTP 503 by the global exception handler so the UI can show a
