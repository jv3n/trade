...
/**
 * Raw output of a [com.portfolioai.market.infrastructure.market.MarketChartClient] : the latest
 * quote and the OHLC time series, both in domain types. No indicators yet — those are computed by
