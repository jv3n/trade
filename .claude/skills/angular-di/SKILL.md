---
name: angular-di
description: Implement dependency injection in Angular v21+ using inject(), injection tokens, and provider configuration for the PortfolioAI frontend. Use for service architecture, providing dependencies at different levels, creating injectable tokens, and managing singleton vs scoped services. Triggers on service creation, configuring providers, using injection tokens, or understanding DI hierarchy.
---

# Angular Dependency Injection

Configure and use dependency injection in Angular v21+ (the version used in `frontend/`) with `inject()` and providers. Cross-feature singletons live under `frontend/src/app/core/`.
