...
description: Implement signal-based reactive state management in Angular v21+ for the PortfolioAI frontend. Use for creating reactive state with signal(), derived state with computed(), dependent state with linkedSignal(), and side effects with effect(). Triggers on state management questions, converting from BehaviorSubject/Observable patterns to signals, or implementing reactive data flows.
---
...
NEVER use effects for state derivation.
