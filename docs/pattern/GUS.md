# Pattern Gap Up Short — fiche de révision

> On **shorte** une small-cap US qui a gap up au premarket sans *fundamental* derrière. Le pari : le cours retombe dans la journée parce que le pump est artificiel.

---

## Checklist d'entrée

Tous les critères se valident **en même temps**. Un seul KO → pas de trade.
...
Quand une société cote **sous $1 trop longtemps**, le Nasdaq / NYSE menace d'un **delisting**. Pour éviter ça, la boîte regroupe ses *shares* → le prix monte mécaniquement sans aucun mouvement réel.

**Exemple** — reverse split 1-pour-10 sur un titre à $0.50 :

- Avant : 1000 *shares* à $0.50 = $500
- Après : 100 *shares* à $5 = $500 (même valeur)
