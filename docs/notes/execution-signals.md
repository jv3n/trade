...
## Inside another setup

The classic double top is a setup of its own (≥ 50 % extension, 17-20 % rejection). Inside a GUS it
looks different, smaller : a **5-15 % push, a 5-15 % rejection, a retest**. Same for the penny break.
That combination is the best trade there is — the win rate of the setup around it, with the risk /
