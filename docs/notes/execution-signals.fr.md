...
Le double top classique est un setup à part entière (extension ≥ 50 %, rejet de 17-20 %). Dans un GUS,
il a une autre allure, plus petite : un **push de 5-15 %, un rejet de 5-15 %, un retest**. Pareil pour
le penny break. Cette combinaison est le meilleur trade qui soit — le win rate du setup autour, avec le
