...
- [2026-06-15 — Revue globale repo complet (post-pivot : audit `HEAD` tout le repo, live + dormant — revue solo une passe, profond sur journal/stats/lexicon/auth/config/sécurité + greps systémiques transverses — 0 Bloquant, 3 À discuter (validation Bean absente des écritures live, mapping 409 trop large, surface du code dormant câblé), 5 Mineurs — verdict `solid / minor-fixes`)](./2026-06-15-revue-globale.md)
